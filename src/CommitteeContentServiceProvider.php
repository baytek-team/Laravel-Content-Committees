...
class CommitteeContentServiceProvider extends AuthServiceProvider
{
    use Settable;
     ...
     */
    protected $policies = [
        Models\Committee::class => Policies\CommitteePolicy::class
    ];
     ...
     */
    protected $commands = [
        Commands\CommitteeInstaller::class,
    ];
     ...
     */
    protected $settings = [
        // 'committee' => Settings\CommitteeSettings::class
    ];
    ...
    public function boot()
    {
        ...
        $this->loadViewsFrom(__DIR__.'/../views', 'committees');
        ...
        $this->publishes([
            __DIR__.'/../views' => resource_path('views/vendor/committees'),
        ], 'views');

        $this->publishes([
            __DIR__.'/../config/committee.php' => config_path('committee.php'),
        ], 'config');
